...
class CategoryModel extends \yii\easyii\components\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['seo_title', 'seo_description', 'seo_keywords', 'seo_h1'], 'safe'],
        ];
    }
    ...
    public function behaviors()
    {
        return [
            ...
            'ml' => [
                ...
                'tableName' => static::tableName().'_lang',
                'attributes' => [
                    'title', 'seo_title', 'seo_description', 'seo_keywords', 'seo_h1'
                ]
            ]
        ];
    }
    ...
    {
        $cache = Yii::$app->cache;
        $key = static::tableName().'_tree_'.Yii::$app->urlManager->getCurLangCode();
    ...
    {
        $cache = Yii::$app->cache;
        $key = static::tableName().'_flat_'.Yii::$app->urlManager->getCurLangCode();
    ...
    {
        $collection = static::find()->localized(Yii::$app->urlManager->getCurLangCode())->with('seo')->sort()->asArray()->all();
        $trees = array();
        $l = 0;
