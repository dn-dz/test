...
class m000000_000000_install extends \yii\db\Migration
{
    ...
    public function up()
    {
        ...
        $this->createIndex('slug', Price::tableName(), 'slug', true);
        ...
        $this->createTable(Page::tableName(), [
            ...
            'text' => Schema::TYPE_TEXT . ' NOT NULL',
            'slug' => Schema::TYPE_STRING . '(128) DEFAULT NULL',
            'parrent_page_id' => Schema::TYPE_INTEGER . ' DEFAULT NULL',
            'price_id' => Schema::TYPE_INTEGER . ' DEFAULT NULL'
        ], $this->engine);
        $this->createIndex('slug', Page::tableName(), 'slug', true);

        $this->createTable(Page::tableName().'_lang', [
            'id' => 'pk',
