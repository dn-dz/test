<?php
namespace yii\easyii\modules\price\api;

use Yii;
use yii\easyii\components\API;
use yii\easyii\models\Photo;
use yii\easyii\modules\price\models\Price as PriceModel;
use yii\helpers\Url;

class PriceObject extends \yii\easyii\components\ApiObject
{
    public $slug;
    public $image;
    public $views;
