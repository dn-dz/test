    ...
    <div class="tab-content" style="padding-top: 30px">
        ...
        <div role="tabpanel" class="tab-pane <?= $n===1 ? 'active': '' ?>" id="post_lang_<?= $code ?>">
            <?php if($code == Yii::$app->params['defaultLanguage']) { ?>
                ...
                <?= $form->field($model, 'menu_position')->textInput(['maxlength' => 255]); ?>
...
<?php /*            <?= $form->field($model, 'seo_title_'.$code)->textInput(['maxlength' => 255]); ?>
...
<?= $form->field($model, 'parrent_page_id')->dropDownlist(Menu::dropdownList($model->page_id)) ?>
